	...
	$.fn.autoSuggest = function(data, options) {
		...
		if(typeof data == "string") {
			...
			for (k in data) if (data.hasOwnProperty(k)) d_count++;
                ...
                else{ /* TIBO modified: Added support for data as function */
					...
					switch(e.keyCode) {
						...
						default:
							...
							break;
                                ...
                                /* TIBO modified: Added support for data as function */
				function processRawData(data, string){
                                    d_count = 0;
                                    var new_data = opts.retrieveComplete.call(this, data);
				    for (k in new_data) if (new_data.hasOwnProperty(k)) d_count++;
				    processData(new_data, string); 
                                };  /*End  TIBO modified: Added support for data as function */
				function keyChange() {
					...
					if (string.length >= opts.minChars) {
						...
						if(d_type == "string"){
						...
						} else if(d_type=="object") { /* TIBO modified: Added support for data as function */
							if(opts.beforeRetrieve){
								string = opts.beforeRetrieve.call(this, string);
							}
							processData(org_data, string);
								...
								string = opts.beforeRetrieve.call(this, string);
                                                    ...
                                                    data(string,function(data){processRawData(data,string)})
                                                } /*END TIBO modified: Added support for data as function */
					} else {
